...
users_uniques4['canonical_course_id'] = [row[3] for row in courses]

users_uniques = pd.concat([users_uniques1,users_uniques2,users_uniques3,users_uniques4])
...
rec_modelo_v1['model_version'] = '1.0'
...
output.to_sql('output_api_t',e2, if_exists='replace')
